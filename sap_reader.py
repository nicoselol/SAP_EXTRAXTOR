from sap_client import get_connection
...
def leer_tabla_por_anio(tabla, anio):
...
def leer_tabla_por_mes(tabla, anio, mes):
...
def leer_tabla_por_rango(tabla, anio, mes_inicio, mes_fin):
